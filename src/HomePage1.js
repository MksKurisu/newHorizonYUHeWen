    	...
    	<Layout className="father">
    		<Header className="headerContainer">
		      ...
		      <div className="middleHeader">
			    	...
			    	<div className="decorate">
				    	...
				    	<div id="tiyan">
				    		<Link to='login'><h1>立即免费体验</h1></Link>
				    	</div>
			    	</div>
		      </div>
		    </Header>
		    <Layout className="middle">
		        ...
		        style={{ background: '#fff' }}>
			         <Link to='/login'><Menu onClick={this.handleClick} style={{ width: 200 }} mode="vertical" className="verticalContainer">
					    <SubMenu key="sub1" title={<span><span>初一</span></span>}>
					      	<Menu.Item key="1">基础</Menu.Item>
					        <Menu.Item key="2">阅读</Menu.Item>
					        <Menu.Item key="3">写作</Menu.Item>
					    </SubMenu>
					    <SubMenu key="sub2" title={<span><span>初二</span></span>}>
					      <Menu.Item key="4">基础</Menu.Item>
					      <Menu.Item key="5">阅读</Menu.Item>
					      <Menu.Item key="6">写作</Menu.Item>
					    </SubMenu>
					    <SubMenu key="sub4" title={<span><span>初三</span></span>}>
					      <Menu.Item key="7">基础</Menu.Item>
					      <Menu.Item key="8">阅读</Menu.Item>
					      <Menu.Item key="9">写作</Menu.Item>
					    </SubMenu>
					</Menu></Link>
		        </Sider>
